...
export function ServiceZimmerRaeumungLayout({ slug, theme }: Props) {
  const t = useTranslations("services.zimmerRaeumung");
  ...
  const studentItems = [t("student1"), t("student2"), t("student3"), t("student4")];
  const valueItems = [t("value1"), t("value2"), t("value3"), t("value4")];
  const quickItems = [t("quick1"), t("quick2"), t("quick3"), t("quick4")];
  const envItems = [t("env1"), t("env2"), t("env3"), t("env4")];
  ...
  return (
    <div className={`max-w-4xl mx-auto px-4 sm:px-6 py-10 md:py-14 ${theme.zLayoutBg}`}>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold text-navy mb-2">{t("studentTitle")}</h2>
        <p className={`${theme.textColor} text-sm mb-4`}>{t("studentIntro")}</p>
        <ul className="space-y-2">
          {studentItems.map((text, i) => (
      ...
      {/* Quick solutions */}
      <section className="mb-10">
        <h2 className="text-xl font-bold text-navy mb-4">{t("quickTitle")}</h2>
      ...
      {/* Env disposal */}
      <section className="mb-10">
        <h2 className="text-xl font-bold text-navy mb-2">{t("envTitle")}</h2>
        <p className={`${theme.textColor} text-sm mb-4`}>{t("envIntro")}</p>
      ...
      <section className="mb-10 p-4 rounded-xl border border-navy/10 bg-navy/5">
        <h2 className="text-xl font-bold text-navy mb-4">{t("familyTitle")}</h2>
        <ul className="space-y-2">

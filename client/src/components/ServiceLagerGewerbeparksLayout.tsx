...
export function ServiceLagerGewerbeparksLayout({ slug, theme }: Props) {
  const t = useTranslations("services.lagerGewerbeparks");
  ...
  return (
    <div className={`max-w-4xl mx-auto px-4 sm:px-6 py-10 md:py-14 ${theme.zLayoutBg}`}>
      ...
      <motion.section initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10">
        ...
        <p className={`${theme.textColor} text-sm italic`}>{t("introNote")}</p>
      </motion.section>

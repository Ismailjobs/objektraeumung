...
import { PHONE_DISPLAY, PHONE_LINK, WHATSAPP_URL, EMAIL, ADDRESS, SOCIAL_LINKS } from "@/lib/constants";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10">
          ...
          <div>
            ...
            <nav className="flex flex-wrap gap-3" aria-label={tNav("socialMedia")}>
              {SOCIAL_LINKS.map(({ key, href }) => (
                <a
                  ...
                  aria-label={tNav(`social.${key}`)}
                  className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-white/10 text-white/90 hover:bg-accent hover:text-white transition-colors"
                >

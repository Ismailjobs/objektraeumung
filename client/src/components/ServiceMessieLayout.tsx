...
export function ServiceMessieLayout({ slug, theme }: Props) {
  const t = useTranslations("services.messieEntruempelung");
  ...
  return (
    <div className={`max-w-4xl mx-auto px-4 sm:px-6 py-10 md:py-14 ${theme.zLayoutBg}`}>
      ...
      {/* Guide note (text only, no link to external page) */}
      <p className={`text-sm ${theme.textColor} mb-10 p-3 rounded-xl bg-navy/5 border border-navy/10`}>
        {t("guideNote")}
      </p>

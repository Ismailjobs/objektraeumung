...
export async function LocationWien1020Content({ locale }: Props) {
  const t = await getTranslations("locationWien1020");
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="bg-navy text-white py-8 md:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs uppercase tracking-wider text-gray-500 mb-6 flex-wrap">
            ...
            <ChevronRight size={14} className="shrink-0" />
            <Link href="/locations/wien" className="hover:text-gray-400 transition-colors">
              {tLoc("stateNames.wien")}
            </Link>
            <ChevronRight size={14} className="shrink-0" />
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16 space-y-14 md:space-y-18">
        ...
        <LocationEeatBlocks translationKey="locationWien1020" />
        ...
        <section className="p-6 md:p-8 rounded-2xl bg-slate-50 border border-navy/10">
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3 text-navy/85">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="p-5 rounded-xl bg-white border border-navy/10">
              <span className="text-xs font-bold text-accent uppercase tracking-wider">{t("stepLabel")} 1</span>
              <h3 className="mt-1 font-bold text-navy">{t("step1Title")}</h3>
              <p className="mt-2 text-sm text-navy/70 leading-relaxed">{t("step1Desc")}</p>
            </div>
            <div className="p-5 rounded-xl bg-white border border-navy/10">
              <span className="text-xs font-bold text-accent uppercase tracking-wider">{t("stepLabel")} 2</span>
              <h3 className="mt-1 font-bold text-navy">{t("step2Title")}</h3>
              <p className="mt-2 text-sm text-navy/70 leading-relaxed">{t("step2Desc")}</p>
            </div>
            <div className="p-5 rounded-xl bg-white border border-navy/10">
              <span className="text-xs font-bold text-accent uppercase tracking-wider">{t("stepLabel")} 3</span>
              <h3 className="mt-1 font-bold text-navy">{t("step3Title")}</h3>
              <p className="mt-2 text-sm text-navy/70 leading-relaxed">{t("step3Desc")}</p>
            </div>
            <div className="p-5 rounded-xl bg-white border border-navy/10">
              <span className="text-xs font-bold text-accent uppercase tracking-wider">{t("stepLabel")} 4</span>
              <h3 className="mt-1 font-bold text-navy">{t("step4Title")}</h3>
              <p className="mt-2 text-sm text-navy/70 leading-relaxed">{t("step4Desc")}</p>
            </div>
            <div className="p-5 rounded-xl bg-white border border-navy/10">
              <span className="text-xs font-bold text-accent uppercase tracking-wider">{t("stepLabel")} 5</span>
              <h3 className="mt-1 font-bold text-navy">{t("step5Title")}</h3>
              <p className="mt-2 text-sm text-navy/70 leading-relaxed">{t("step5Desc")}</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <dl className="space-y-6">
            <div className="pb-6 border-b border-navy/10">
              <dt className="font-semibold text-navy mb-1">{t("faq1Q")}</dt>
              <dd className="text-navy/80 text-sm md:text-base leading-relaxed">{t("faq1A")}</dd>
            </div>
            <div className="pb-6 border-b border-navy/10">
              <dt className="font-semibold text-navy mb-1">{t("faq2Q")}</dt>
              <dd className="text-navy/80 text-sm md:text-base leading-relaxed">{t("faq2A")}</dd>
            </div>
            <div className="pb-6 border-b border-navy/10">
              <dt className="font-semibold text-navy mb-1">{t("faq3Q")}</dt>
              <dd className="text-navy/80 text-sm md:text-base leading-relaxed">{t("faq3A")}</dd>
            </div>
          </dl>
        </section>

...
export async function LocationWien1160Content({ locale }: Props) {
  const t = await getTranslations("locationWien1160");
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-12 md:py-16 space-y-14 md:space-y-18">
        ...
        <LocationEeatBlocks translationKey="locationWien1160" />

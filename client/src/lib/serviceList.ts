...
export const SERVICE_LIST: { slug: string; titleKey: string; contentKey: ContentKey }[] = [
  ...
  { slug: "entsorgung-wien", titleKey: "entsorgungWien", contentKey: "general" },
...
/** Slug bazlı hero dosyası (public/services/{folder}/ altında). */
export const HERO_IMAGE_BY_SLUG: Record<string, string> = {
  "entsorgung-wien": "hero.webp",
};

export function getHeroImageFilename(slug: string): string {
  return HERO_IMAGE_BY_SLUG[slug] ?? "hero.webp";
}

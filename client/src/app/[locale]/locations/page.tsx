...
export function generateMetadata() {
  return {
    title: "Standorte | Objekträumung",
    description: "Wien, Niederösterreich, Burgenland, Steiermark, Kärnten, Oberösterreich, Salzburg. Festpreis-Entrümpelung in ganz Österreich.",
  };
}
...
export default async function LocationsPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <PageStructuredData graph={locationsHubSchema} />
      {/* Header */}

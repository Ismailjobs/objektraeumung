...
export function generateMetadata() {
  return {
    title: "Über uns | Objekträumung",
    description: "Objekträumung: Team & Mission. Geprüfte Teams, Fixpreis, Wertausgleich. Zertifizierungen, MA 48-Partner.",
  };
}
...
export default async function AboutPage({ params }: Props) {
  ...
  const aboutMetaDescription =
    "Objekträumung: Team & Mission. Geprüfte Teams, Fixpreis, Wertausgleich. Zertifizierungen, MA 48-Partner.";
    ...
    <div className="min-h-screen bg-white">
      <PageStructuredData
        graph={buildSimpleContentPageGraph({
          path: "/about",
          name: "Über uns | Objekträumung",
          description: aboutMetaDescription,
          breadcrumbs: [
            { name: tNav("home"), item: SITE_URL },
            { name: t("breadcrumb"), item: canonicalToAbsolute("/about") },
          ],
        })}
      />
